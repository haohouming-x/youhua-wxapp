...
export default {
 ...
 methods: {
   ...mapActions({
     ...
     getStoreUpGoods: 'goods/getStoreUpGoods'
   }),
   handleClassify (item){
    this.checkout(item.name);
   ...
   checkoutToStoreUp() {
     ...
     this.getStoreUpGoods({page: this.page});
   },
   checkout(name) {
     this.headline = name;
     this.page = 1;
